/* ─── US Renovation Cost Data (2024, national averages) ─── */
const COST_DATA = {
  kitchen: {
    label: 'Kitchen', icon: '🍳',
    base: { low: 15000, mid: 40000, high: 80000 },
    perSqft: { low: 75, mid: 150, high: 300 },
  ...
  bathroom: {
    label: 'Bathroom', icon: '🚿',
    base: { low: 6000, mid: 15000, high: 35000 },
    perSqft: { low: 120, mid: 250, high: 500 },
  ...
  bedroom: {
    ...
    base: { low: 3000, mid: 8000, high: 20000 },
    perSqft: { low: 20, mid: 50, high: 120 },
  ...
  living: {
    ...
    base: { low: 4000, mid: 10000, high: 25000 },
    perSqft: { low: 18, mid: 45, high: 110 },
  ...
  basement: {
    ...
    base: { low: 10000, mid: 27000, high: 60000 },
    perSqft: { low: 25, mid: 55, high: 130 },
  ...
  roof: {
    label: 'Roof', icon: '🏠',
    base: { low: 5500, mid: 12000, high: 28000 },
    perSqft: { low: 3.5, mid: 6, high: 12 },
  ...
  garage: {
    label: 'Garage', icon: '🚗',
    base: { low: 3500, mid: 9000, high: 22000 },
    perSqft: { low: 15, mid: 35, high: 80 },
...
const QUALITY_MULT = { budget: 0.7, standard: 1.0, premium: 1.7 };
...
function calculateAndShow() {
  ...
  const scopeMult = selected.scope === 'cosmetic' ? 0.45 : selected.scope === 'partial' ? 0.70 : 1.0;
  ...
  const fmt = n => '$' + Math.round(n / 100) * 100 >= 1000
